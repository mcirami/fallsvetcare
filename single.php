						...
						<div class="my_row">
							...
							the_post_navigation(
								array(
									...
									</svg>' . esc_html__( 'Previous:', 'fallsvetcare' ) . '</span> <span class="nav-title">%title</span>',
									'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'fallsvetcare' ) . '</span> <span class="nav-title">
									%title
